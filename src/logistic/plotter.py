...
def run_binary_and_capture_output():
    ...
    process = subprocess.Popen(['./logistic/main'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    with open('./logistic/logistic_dataset.csv', 'r') as infile:
