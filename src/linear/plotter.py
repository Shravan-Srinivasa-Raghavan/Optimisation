...
def run_binary_and_capture_output():
    ...
    process = subprocess.Popen(['./linear/main'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    with open('./linear/linear_dataset.csv', 'r') as infile:
