...
// I have changed the function with default parameter as false because I do not want device info to be printed whenever code is run
...
public:
	...
	inline Device(const Device_Info& info, const string& opencl_c_code=get_opencl_c_code()) {
		// Commented this line because device info is not necessary
		...
		// Commented this line because it is unnecessary
